...
function Containers(props) {
  ...
  let randomCount = Math.floor(Math.random()*200)

  let randomComments = []
  for (let index = 0; index < randomCount; index++) {
    randomComments.push(<Comments key={index}/>)
  }
            ...
            <div className='author--section'>
              <div className='author--section--child1'>
                  ...
                  {(()=>{
                    ...
                    return(
                      <button className='btn btn-dark subs--button' type='button' id={props.collections[props.targetVideo].authorID} onClick={(e)=>props.handleClicks(e)}>Subscribe</button>
                    )
                  })()}
              </div>
